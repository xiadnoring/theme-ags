...
import { Gtk, Log } from '../lib/imports';
...
const volumeState = Variable (iconByState());
...
export default function getAudioVolumnState (props: {percentage: boolean}) {
    return <eventbox onScroll={(self, event) => {
        ...
        <box className="icon-box audio-volume-box" valign={Gtk.Align.CENTER}>
            <label className="icon-material font-1-5" label={volumeState()} />
